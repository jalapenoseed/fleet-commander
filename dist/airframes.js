...
/**
 * ELI5: This file loads detailed GLB aircraft and also builds lightweight
 * procedural fallback drones from boxes, rods, spheres, and rotors. Geometry
 * constructor values and `position.set(x, y, z)` values are model-space metres:
 * they move parts relative to the center of one drone, not across the world.
 */
