/**
 * ELI5: This translates mouse/touch gestures into camera changes. One-finger
 * drag rotates, two-finger pinch zooms, and a short click places an objective
 * only in the allowed overview views. The `0.005`/`0.004` values below are
 * rotation sensitivity; the `6`-pixel threshold separates a click from a drag.
 */
