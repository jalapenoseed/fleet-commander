/**
 * ELI5: This is deterministic game AI: it chooses targets, attack runs,
 * evasive breaks, retreats, and allied spacing. It does not learn or control
 * real aircraft. Defaults describe an ordinary battle; presets below override
 * only the values that make each game mode different.
 */
...
// ELI5: Multipliers use 1 as normal, 0 as off, and values above 1 as stronger.
// `reaction`, `payloadCooldown`, and `roundSeconds` are seconds.
...
// ELI5: These validation ranges stop a menu or imported file using wild values.
const limits = {
  speed: [0.4, 1.6],
  damage: [0, 2],
  aggression: [0, 1],
