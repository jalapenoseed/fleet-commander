...
/**
 * ELI5: A swarm program turns one instruction into one destination per drone.
 * Shapes choose the basic arrangement, influence fields bend that arrangement,
 * and shows/patterns add movement over time. This file calculates targets; the
 * core simulation still decides how quickly physical drone bodies reach them.
 */
...
// ELI5: This is the best single block for changing the default formation.
// Distances are metres, times are seconds, rotation is degrees in the editor,
// and BPM means beats per minute. PROGRAM_RANGES below limits user input.
const DEFAULTS = {
  ...BOID_DEFAULTS,
  ...EFFECT_DEFAULTS,
