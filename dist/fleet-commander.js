import { mountCommandShell } from './command-shell.js?v=0.9.0';
...
/**
 * ELI5: This is the switchboard. The HTML creates controls, this file listens
 * for clicks/changes, and then it calls the simulation, renderer, Director,
 * Arena, Lab, Art, audio, and save systems. `$` below is only a short helper for
 * finding an HTML element by its id; `sim` is the one live CommanderSimulation.
 * System math belongs in focused modules rather than inside button handlers.
 */
