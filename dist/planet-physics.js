/**
 * ELI5: This file is the educational mass, gravity, atmosphere, and battery
 * calculator. The values are illustrative game inputs, not aircraft or weapons
 * engineering predictions. Gravity is m/s², density is kg/m³, mass is kg,
 * battery capacity is Wh, and power is watts.
 */
// ELI5: Add or tune a world here, then provide matching sky/scenery keys in
// director-environment.js and add tests for its special rules.
...
// ELI5: These are the values shown before a saved Lab configuration replaces them.
