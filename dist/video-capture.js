/**
 * ELI5: Recording repeatedly copies the game canvas (and optional digital HUD)
 * into another canvas, then gives that stream plus optional game audio to the
 * browser's MediaRecorder. It never asks for microphone access.
 */
